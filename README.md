...
#### Baryons
* proton (![p](https://render.githubusercontent.com/render/math?math=p))
* anti_proton (![\bar{p}](https://render.githubusercontent.com/render/math?math=%5Cbar%7Bp%7D))
* neutron (![n](https://render.githubusercontent.com/render/math?math=n))
* lambda (![\Lambda^{0}](https://render.githubusercontent.com/render/math?math=%5CLambda%5E%7B0%7D))
* anti_lambda (![\bar{\Lambda}^{0}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CLambda%7D%5E%7B0%7D))
* sigma (![\Sigma^{+}](https://render.githubusercontent.com/render/math?math=%5CSigma%5E%7B%2B%7D))
* anti_sigma (![\bar{\Sigma}^{-}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CSigma%7D%5E%7B-%7D))
* sigma0 (![\Sigma^{0}](https://render.githubusercontent.com/render/math?math=%5CSigma%5E%7B0%7D))
* anti_sigma0 (![\bar{\Sigma}^{0}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CSigma%7D%5E%7B0%7D))
* sigma_minus (![\Sigma^{-}](https://render.githubusercontent.com/render/math?math=%5CSigma%5E%7B-%7D))
* anti_sigma_minus (![\bar{\Sigma}^{+}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CSigma%7D%5E%7B%2B%7D))
* delta (![\Delta^{++}](https://render.githubusercontent.com/render/math?math=%5CDelta%5E%7B%2B%2B%7D))
* anti_delta (![\bar{\Delta}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CDelta%7D))
* delta_plus (![\Delta^{+}](https://render.githubusercontent.com/render/math?math=%5CDelta%5E%7B%2B%7D))
* anti_delta_plus (![\bar{\Delta}^{-}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CDelta%7D%5E%7B-%7D))
* delta0 (![\Delta^{0}](https://render.githubusercontent.com/render/math?math=%5CDelta%5E%7B0%7D))
* anti_delta0 (![\bar{\Delta}^{0}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CDelta%7D%5E%7B0%7D))
* delta_minus (![\Delta^{-}](https://render.githubusercontent.com/render/math?math=%5CDelta%5E%7B-%7D))
* anti_delta_minus (![\bar{\Delta}^{+}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CDelta%7D%5E%7B%2B%7D))
* xi0 (![\Xi^{0}](https://render.githubusercontent.com/render/math?math=%5CXi%5E%7B0%7D))
* anti_xi0 (![\bar{\Xi}^{0}](https://render.githubusercontent.com/render/math?math=%5Cbar%7B%5CXi%7D%5E%7B0%7D))
* xi_minus (![\Xi^{-}](https://render.githubusercontent.com/render/math?math=%5CXi%5E%7B-%7D))
* anti_xi_minus (![\Xi^{+}](https://render.githubusercontent.com/render/math?math=%5CXi%5E%7B%2B%7D))
* omega (![\Omega^{-}](https://render.githubusercontent.com/render/math?math=%5COmega%5E%7B-%7D))
* anti_omega (![\Omega^{+}](https://render.githubusercontent.com/render/math?math=%5COmega%5E%7B%2B%7D))
